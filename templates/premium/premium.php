...
<?php $admin = YITH_Advanced_Refund_System_Admin::get_instance(); ?>
<div class="landing">
    <div class="section section-cta section-odd">
        <div class="landing-container">
            <div class="premium-cta">
                <p>
                    <?php echo sprintf( esc_html__('Upgrade to %1$spremium version%2$s of %1$sYITH Advanced Refund System for WooCommerce%2$s to benefit from all features!','yith-advanced-refund-system-for-woocommerce'),'<span class="highlight">','</span>' );?>
                </p>
                <a href="<?php echo $admin->get_premium_landing_uri(); ?>" target="_blank" class="premium-cta-button button btn">
                    <span class="highlight"><?php esc_html_e('UPGRADE','yith-advanced-refund-system-for-woocommerce');?></span>
                    <span><?php esc_html_e('to the premium version','yith-advanced-refund-system-for-woocommerce');?></span>
                </a>
            </div>
        </div>
    </div>
    <div class="one section section-even clear">
        <h1><?php esc_html_e('Premium Features','yith-advanced-refund-system-for-woocommerce');?></h1>
        <div class="landing-container">
            <div class="col-1">
            ...
            <div class="col-2">
                <div class="section-title">
                    ...
                    <h2><?php esc_html_e('Refund the entire order or a single product in it','yith-advanced-refund-system-for-woocommerce');?></h2>
                </div>
                <p>
                ...
                <p>
                    <?php esc_html_e('This will reduce refund requests for whole orders in case the customer is not satisfied with one product only.', 'yith-advanced-refund-system-for-woocommerce');?>
                </p>
        ...
        <div class="landing-container">
            <div class="col-2">
                <div class="section-title">
                    ...
                    <h2><?php esc_html_e('Accept all requests automatically','yith-advanced-refund-system-for-woocommerce');?></h2>
                </div>
                <p>
                ...
                <p>
                    <?php esc_html_e('In case there’s no payment gateway associated, you can keep managing refunds manually.', 'yith-advanced-refund-system-for-woocommerce');?>
                </p>
            </div>
            <div class="col-1">
        ...
        <div class="landing-container">
            ...
            <div class="col-2">
                <div class="section-title">
                    ...
                    <h2><?php esc_html_e('Offer a coupon','yith-advanced-refund-system-for-woocommerce');?></h2>
                </div>
                <p>
        ...
        <div class="landing-container">
            <div class="col-2">
                <div class="section-title">
                    ...
                    <h2><?php esc_html_e('Automatically restock products','yith-advanced-refund-system-for-woocommerce');?></h2>
                </div>
                <p>
        ...
        <div class="landing-container">
            ...
            <div class="col-2">
                <div class="section-title">
                    ...
                    <h2><?php esc_html_e('Allow refunds based on the order total','yith-advanced-refund-system-for-woocommerce');?></h2>
                </div>
                <p>
        ...
        <div class="landing-container">
            <div class="col-2">
                <div class="section-title">
                    ...
                    <h2><?php esc_html_e('Allow file upload','yith-advanced-refund-system-for-woocommerce');?></h2>
                </div>
                <p>
        ...
        <div class="landing-container">
            ...
            <div class="col-2">
                <div class="section-title">
                    ...
                    <h2><?php esc_html_e('Configure refund settings on the single product','yith-advanced-refund-system-for-woocommerce');?></h2>
                </div>
                <p>
                    <?php esc_html_e('For each single product, whether it be simple or variable, you can enable or disable refunds, set up a deadline for new refund requests and customize the message shown on non-refundable products.', 'yith-advanced-refund-system-for-woocommerce');?>
                </p>
            </div>
        </div>
    </div>
        ...
        <div class="landing-container">
            <div class="col-2">
                <div class="section-title">
                    ...
                    <h2><?php esc_html_e('Show a message on non-refundable products','yith-advanced-refund-system-for-woocommerce');?></h2>
                </div>
                <p>
